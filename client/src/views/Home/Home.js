  ...
  return (
    <>
      ...
      {products?.map((product, index) => {
        ...
        return (
          <div className="card shadow text-center d-flex" style={{ width: "15rem" }} key={index}>
            <div className="card-body ">
            <img src={productImage} alt="product" height="100px" className="d-block mx-auto image" />
            ...
            <a href="/product/:${_id}" className="">View More</a>
            </div>
